...
import ctypes as c
import weakref
class TerrainPlane(_pal.PalObject):
    ...
    def get_location(self):
        ...
        ret = _pal.Mat4x4()
        _pal.lib.body_static_terrain_plane_get_location(self.obj, ret)
    ...
    def set_group(self, group):
        return _pal.lib.body_static_terrain_plane_set_group(self.obj, c.c_int(group))
